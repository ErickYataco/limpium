    ...
    <div id="content">
        <section>
            ...
            <div class="section-body contain-lg">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <article class="margin-bottom-xxl">
                            <p class="lead">
                                Edicion de contratos y requerimientos
                            </p>
                        </article>
                    </div><!--end .col -->
                </div><!--end .row -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        {!! Form::model($account,array('url' => '/comercial/contrato', 'id'=>'formCreate','method' => 'post','role' => 'form', 'novalidate'=>'novalidate', 'class'=>'form floating-label form-validation'))!!}
                        @include('Comercial.Contract.form')
                        {!! Form::close() !!}
                    </div><!--end .col -->
                </div><!--end .row -->
